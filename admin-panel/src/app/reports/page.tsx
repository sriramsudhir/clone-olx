  ...
  const reports = [
    {
      ...
      description: 'This listing contains inappropriate images and misleading information',
    ...
    },
    {
      ...
      type: 'user',
      reason: 'Spam',
      description: 'User is sending spam messages to multiple users and posting fake listings',
    ...
    },
    {
      ...
      type: 'listing',
      reason: 'Fake Product',
      description: 'This appears to be a counterfeit product being sold as authentic',
    ...
    },
    {
      ...
      type: 'user',
      reason: 'Harassment',
      description: 'User is harassing other members through messages and comments',
    ...
    },
    {
      ...
      description: 'Artificially inflated prices compared to market value',
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold font-heading">Reports Management</h1>
