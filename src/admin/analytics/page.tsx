...
export default function AdminAnalyticsPage() {
  ...
  const analyticsData = {
    ...
    bounceRate: 42.3,
    topCategories: [
      { name: 'Electronics', count: 342, percentage: 27.2 },
      { name: 'Vehicles', count: 289, percentage: 23.0 },
      { name: 'Fashion', count: 198, percentage: 15.8 },
      { name: 'Home & Garden', count: 156, percentage: 12.4 },
      { name: 'Sports', count: 134, percentage: 10.7 }
    ],
    recentMetrics: [
      { period: 'Today', users: 234, listings: 45, revenue: 2340 },
      { period: 'Yesterday', users: 198, listings: 38, revenue: 1980 },
      { period: 'This Week', users: 1456, listings: 289, revenue: 15670 },
      { period: 'Last Week', users: 1234, listings: 245, revenue: 13450 },
      { period: 'This Month', users: 5678, listings: 1123, revenue: 67890 },
      { period: 'Last Month', users: 4567, listings: 987, revenue: 56780 }
    ]
  };
